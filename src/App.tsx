        ...
        {/* <div style={{
          ...
          <div style={{padding: 10}}>
            ...
            <div style={{fontSize: 30, marginTop: 30, marginBottom: 15}}>
              The team is working on IniSwap upgraded version!
            </div>
            ...
            <div style={{opacity: 0.7}}>For more information: <a style={{color: '#ffffff'}} href="https://twitter.com/IniSwap">Twitter</a></div>
          </div>
        </div> */}
        <Switch>
          <Route path="/" exact>
